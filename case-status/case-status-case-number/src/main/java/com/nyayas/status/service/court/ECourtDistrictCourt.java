...
@Service
public class ECourtDistrictCourt extends CaseStatusByCaseNumberService {
	...
	public boolean supports(Class<CaseNumberService> clazz, Object id) {
		return CaseNumberService.class.equals(clazz) && id.equals(Courts.ECOURT_DISTRICT_COURT.courtCode());
	}
...
//				param.get(CaseFields.DISTRICT_CODE));
		...
		if (jsonCon.isArray()) {
			...
			if (caseDetail.isArray()) {
				...
				map.put(CaseFields.CASE_NUMBER, caseObj.get("case_no").asText());
...
//				map.put(CaseFields.CIN_NUMBER, caseObj.get("cino"));
	...
	public static void main(String[] args) throws Exception {
		CaseNumberService sc = new ECourtDistrictCourt();
