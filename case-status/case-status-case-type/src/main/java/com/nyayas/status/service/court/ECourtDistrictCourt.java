...
@Service
public class ECourtDistrictCourt extends CaseStatusByCaseTypeService {
	...
	public boolean supports(Class<CaseTypeService> clazz, Object id) {
		return CaseTypeService.class.equals(clazz) && id.equals(Courts.ECOURT_DISTRICT_COURT.code());
	}
	...
	public static void main(String[] args) throws Exception {
		CaseTypeService sc = new ECourtDistrictCourt();
