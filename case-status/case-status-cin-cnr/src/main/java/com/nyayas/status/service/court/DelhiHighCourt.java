...
public class DelhiHighCourt extends CaseStatusByCINCNRService {
	...
	public boolean supports(Class<CINCNRService> clazz, Object id) {
		return CINCNRService.class.equals(clazz) && id.equals(Courts.DELHI_HIGH_COURT.courtId());
	}
	...
	public static void main(String[] args) throws IOException {
		...
		CINCNRService css = new DelhiHighCourt();

		Map<String, Object> resp = css.byCINCNR(css.param(map));
